...
class XMLWriter:
    ...
    ##
    # Writes an RSS declaration. (added by marek, april 2012)
    def rssdecl(self):
	encoding = self.__encoding
	self.__write("<rss xmlns:itunes='http://www.itunes.com/dtds/podcast-1.0.dtd' version='2.0' xml:lang='en-US'>")
	self.__open = 1

    def rssdeclclose(self):
	encoding = self.__encoding
	self.__write('</rss>')
